...
import { getField, updateField } from '@/lib/admin-api';
...
export default function EditFieldPage() {
  ...
  useEffect(() => {
    const fetchField = async () => {
      try {
        ...
        console.error('Alan yuklenemedi:', error);
        alert('Alan bulunamadi.');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Alan guncellenirken bir hata olustu.');
      setSaving(false);
    }
  };
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-semibold mt-4">Alani Duzenle</h1>
      </div>
