...
export default function CreateProductPage() {
  ...
  const updateVariation = (index: number, key: keyof VariationForm, value: any) => {
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ör: Colombia Supremo"
                  />
                </div>
                <div>
